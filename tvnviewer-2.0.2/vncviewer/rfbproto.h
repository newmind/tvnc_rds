...
/*
 * FIXME: This file should not be used if possible. New TightVNC code uses
 *        different types, constants and structures (actually, new code should
 *        not use structures for reading/writing data to the network).
 */
...
#define rfbVideoFreeze 152
#define rfbEnableVideoHandling 153
...
#define sig_rfbVideoFreeze "VD_FREEZ"
#define sig_rfbEnableVideoHandling "VD_ENABL"
...
typedef struct _rfbVideoFreezeMsg {
    CARD8 type;
    CARD8 isFreezeRequested;
} rfbVideoFreezeMsg;

#define sz_rfbVideoFreezeMsg 2

/*-----------------------------------------------------------------------------
 * EnableVideoHandling
 */

typedef struct _rfbEnableVideoHandlingMsg {
    CARD8 type;
    CARD8 enableFlag;
} rfbEnableVideoHandlingMsg;

#define sz_rfbEnableVideoHandlingMsg 2
